...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { description: @discussion.description, event_id: @discussion.event_id, topic: @discussion.topic }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { description: @discussion.description, event_id: @discussion.event_id, topic: @discussion.topic }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
